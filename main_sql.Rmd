...
access_index <- glue("CREATE index filter_index on AMBULATORY_ACCESS_TABLE (CAMPUS, CAMPUS_SPECIALTY, DEPARTMENT, RESOURCES, PROVIDER, VISIT_METHOD, APPT_TYPE, APPT_DATE_YEAR, APPT_DAY)")
appt_status_index <- glue("CREATE index status_index on AMBULATORY_ACCESS_TABLE (APPT_STATUS)")
access_index_npr <- glue("CREATE index filter_index_access on AMBULATORY_ACCESS_TABLE (APPT_MADE_DTTM, PROVIDER, APPT_TYPE, DEPARTMENT, CAMPUS_SPECIALTY)")
