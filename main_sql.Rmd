...
SELECT e.*, nvl(e.NEW_PT3_RAW, 'ESTABLISHED') AS NEW_PT3, nvl(e.SCHEDULE_GROUPING, 'Other') AS SCHEDULE_GROUPING_MAPPED,
...
CASE WHEN (CHECKINTOROOMIN BETWEEN 0.0 AND 30.0) THEN '0' WHEN NOT (CHECKINTOROOMIN BETWEEN 0.0 AND 30.0) THEN (CASE WHEN (CHECKINTOROOMIN BETWEEN 30.0 AND 60.0) THEN '30' WHEN NOT (CHECKINTOROOMIN BETWEEN 30.0 AND 60.0) THEN (CASE WHEN (CHECKINTOROOMIN BETWEEN 60.0 AND 90.0) THEN '60' WHEN NOT (CHECKINTOROOMIN BETWEEN 60.0 AND 90.0) THEN (CASE WHEN (CHECKINTOROOMIN BETWEEN 90.0 AND 120.0) THEN '90' WHEN NOT (CHECKINTOROOMIN BETWEEN 90.0 AND 120.0) THEN (CASE WHEN (CHECKINTOROOMIN BETWEEN 120.0 AND 150.0) THEN '120' WHEN NOT (CHECKINTOROOMIN BETWEEN 120.0 AND 150.0) THEN (CASE WHEN (CHECKINTOROOMIN BETWEEN 150.0 AND 180.0) THEN '150' WHEN NOT (CHECKINTOROOMIN BETWEEN 150.0 AND 180.0) THEN (CASE WHEN (CHECKINTOROOMIN BETWEEN 180.0 AND 210.0) THEN '180' WHEN NOT (CHECKINTOROOMIN BETWEEN 180.0 AND 210.0) THEN (CASE WHEN (CHECKINTOROOMIN BETWEEN 210.0 AND 240.0) THEN '210' WHEN NOT (CHECKINTOROOMIN BETWEEN 210.0 AND 240.0) THEN (CASE WHEN (CHECKINTOROOMIN BETWEEN 240.0 AND 270.0) THEN '240' WHEN NOT (CHECKINTOROOMIN BETWEEN 240.0 AND 270.0) THEN (CASE WHEN (CHECKINTOROOMIN BETWEEN 270.0 AND 300.0) THEN '270' WHEN NOT (CHECKINTOROOMIN BETWEEN 270.0 AND 300.0) THEN (CASE WHEN (CHECKINTOROOMIN BETWEEN 300.0 AND 330.0) THEN '300' WHEN NOT (CHECKINTOROOMIN BETWEEN 300.0 AND 330.0) THEN (CASE WHEN (CHECKINTOROOMIN BETWEEN 330.0 AND 360.0) THEN '330' WHEN NOT (CHECKINTOROOMIN BETWEEN 330.0 AND 360.0) THEN (CASE WHEN (CHECKINTOROOMIN BETWEEN 360.0 AND 390.0) THEN '360' WHEN NOT (CHECKINTOROOMIN BETWEEN 360.0 AND 390.0) THEN (CASE WHEN (CHECKINTOROOMIN BETWEEN 390.0 AND 420.0) THEN '390' WHEN NOT (CHECKINTOROOMIN BETWEEN 390.0 AND 420.0) THEN (CASE WHEN (CHECKINTOROOMIN BETWEEN 420.0 AND 450.0) THEN '420' WHEN NOT (CHECKINTOROOMIN BETWEEN 420.0 AND 450.0) THEN (CASE WHEN (CHECKINTOROOMIN BETWEEN 450.0 AND 480.0) THEN '450' WHEN NOT (CHECKINTOROOMIN BETWEEN 450.0 AND 480.0) THEN '480' END) END) END) END) END) END) END) END) END) END) END) END) END) END) END) END AS bin_roomin,
  CASE WHEN (CYCLETIME BETWEEN 0.0 AND 30.0) THEN '0' WHEN NOT (CYCLETIME BETWEEN 0.0 AND 30.0) THEN (CASE WHEN (CYCLETIME BETWEEN 30.0 AND 60.0) THEN '30' WHEN NOT (CYCLETIME BETWEEN 30.0 AND 60.0) THEN (CASE WHEN (CYCLETIME BETWEEN 60.0 AND 90.0) THEN '60' WHEN NOT (CYCLETIME BETWEEN 60.0 AND 90.0) THEN (CASE WHEN (CYCLETIME BETWEEN 90.0 AND 120.0) THEN '90' WHEN NOT (CYCLETIME BETWEEN 90.0 AND 120.0) THEN (CASE WHEN (CYCLETIME BETWEEN 120.0 AND 150.0) THEN '120' WHEN NOT (CYCLETIME BETWEEN 120.0 AND 150.0) THEN (CASE WHEN (CYCLETIME BETWEEN 150.0 AND 180.0) THEN '150' WHEN NOT (CYCLETIME BETWEEN 150.0 AND 180.0) THEN (CASE WHEN (CYCLETIME BETWEEN 180.0 AND 210.0) THEN '180' WHEN NOT (CYCLETIME BETWEEN 180.0 AND 210.0) THEN (CASE WHEN (CYCLETIME BETWEEN 210.0 AND 240.0) THEN '210' WHEN NOT (CYCLETIME BETWEEN 210.0 AND 240.0) THEN (CASE WHEN (CYCLETIME BETWEEN 240.0 AND 270.0) THEN '240' WHEN NOT (CYCLETIME BETWEEN 240.0 AND 270.0) THEN (CASE WHEN (CYCLETIME BETWEEN 270.0 AND 300.0) THEN '270' WHEN NOT (CYCLETIME BETWEEN 270.0 AND 300.0) THEN (CASE WHEN (CYCLETIME BETWEEN 300.0 AND 330.0) THEN '300' WHEN NOT (CYCLETIME BETWEEN 300.0 AND 330.0) THEN (CASE WHEN (CYCLETIME BETWEEN 330.0 AND 360.0) THEN '330' WHEN NOT (CYCLETIME BETWEEN 330.0 AND 360.0) THEN (CASE WHEN (CYCLETIME BETWEEN 360.0 AND 390.0) THEN '360' WHEN NOT (CYCLETIME BETWEEN 360.0 AND 390.0) THEN (CASE WHEN (CYCLETIME BETWEEN 390.0 AND 420.0) THEN '390' WHEN NOT (CYCLETIME BETWEEN 390.0 AND 420.0) THEN (CASE WHEN (CYCLETIME BETWEEN 420.0 AND 450.0) THEN '420' WHEN NOT (CYCLETIME BETWEEN 420.0 AND 450.0) THEN (CASE WHEN (CYCLETIME BETWEEN 450.0 AND 480.0) THEN '450' WHEN NOT (CYCLETIME BETWEEN 450.0 AND 480.0) THEN '480' END) END) END) END) END) END) END) END) END) END) END) END) END) END) END) END AS bin_cycle,
      CASE WHEN (ROOMINTOVISITEND BETWEEN 0.0 AND 30.0) THEN '0' WHEN NOT (ROOMINTOVISITEND BETWEEN 0.0 AND 30.0) THEN (CASE WHEN (ROOMINTOVISITEND BETWEEN 30.0 AND 60.0) THEN '30' WHEN NOT (ROOMINTOVISITEND BETWEEN 30.0 AND 60.0) THEN (CASE WHEN (ROOMINTOVISITEND BETWEEN 60.0 AND 90.0) THEN '60' WHEN NOT (ROOMINTOVISITEND BETWEEN 60.0 AND 90.0) THEN (CASE WHEN (ROOMINTOVISITEND BETWEEN 90.0 AND 120.0) THEN '90' WHEN NOT (ROOMINTOVISITEND BETWEEN 90.0 AND 120.0) THEN (CASE WHEN (ROOMINTOVISITEND BETWEEN 120.0 AND 150.0) THEN '120' WHEN NOT (ROOMINTOVISITEND BETWEEN 120.0 AND 150.0) THEN (CASE WHEN (ROOMINTOVISITEND BETWEEN 150.0 AND 180.0) THEN '150' WHEN NOT (ROOMINTOVISITEND BETWEEN 150.0 AND 180.0) THEN (CASE WHEN (ROOMINTOVISITEND BETWEEN 180.0 AND 210.0) THEN '180' WHEN NOT (ROOMINTOVISITEND BETWEEN 180.0 AND 210.0) THEN (CASE WHEN (ROOMINTOVISITEND BETWEEN 210.0 AND 240.0) THEN '210' WHEN NOT (ROOMINTOVISITEND BETWEEN 210.0 AND 240.0) THEN (CASE WHEN (ROOMINTOVISITEND BETWEEN 240.0 AND 270.0) THEN '240' WHEN NOT (ROOMINTOVISITEND BETWEEN 240.0 AND 270.0) THEN (CASE WHEN (ROOMINTOVISITEND BETWEEN 270.0 AND 300.0) THEN '270' WHEN NOT (ROOMINTOVISITEND BETWEEN 270.0 AND 300.0) THEN (CASE WHEN (ROOMINTOVISITEND BETWEEN 300.0 AND 330.0) THEN '300' WHEN NOT (ROOMINTOVISITEND BETWEEN 300.0 AND 330.0) THEN (CASE WHEN (ROOMINTOVISITEND BETWEEN 330.0 AND 360.0) THEN '330' WHEN NOT (ROOMINTOVISITEND BETWEEN 330.0 AND 360.0) THEN (CASE WHEN (ROOMINTOVISITEND BETWEEN 360.0 AND 390.0) THEN '360' WHEN NOT (ROOMINTOVISITEND BETWEEN 360.0 AND 390.0) THEN (CASE WHEN (ROOMINTOVISITEND BETWEEN 390.0 AND 420.0) THEN '390' WHEN NOT (ROOMINTOVISITEND BETWEEN 390.0 AND 420.0) THEN (CASE WHEN (ROOMINTOVISITEND BETWEEN 420.0 AND 450.0) THEN '420' WHEN NOT (ROOMINTOVISITEND BETWEEN 420.0 AND 450.0) THEN (CASE WHEN (ROOMINTOVISITEND BETWEEN 450.0 AND 480.0) THEN '450' WHEN NOT (ROOMINTOVISITEND BETWEEN 450.0 AND 480.0) THEN '480' END) END) END) END) END) END) END) END) END) END) END) END) END) END) END) END AS bin_roomin_visit_end
...
EXTRACT(year from c.APPT_DTTM) Appt_Year,
 ...
 SELECT a.PROV_NAME_WID, a.PROV_ID, a.DEPARTMENT_ID AS Department_ID, a.REFERRING_PROV_NAME_WID AS Refferring_Provider, a.CYCLE_TIME_MINUTES AS cycleTime,
                             ...
                             TRIM(a.SCHED_METHOD) AS SCHED_METHOD_TRIMMED,
...
FROM MV_DM_PATIENT_ACCESS a
        WHERE a.CONTACT_DATE BETWEEN TO_DATE('{date_1} 00:00:00', 'YYYY-MM-DD HH24:MI:SS')
                    ...
                    LEFT JOIN AMBULATORY_SCHED_METHOD j on d.SCHED_METHOD_TRIMMED = j.SCHED_METHOD
                    ) c
                    )d
                    ) e")
