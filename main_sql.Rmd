...
access_index <- glue("CREATE INDEX access_index_test on AMBULATORY_ACCESS_TEST (APPT_DATE_YEAR, DEPARTMENT)")
access_index_npr <- glue("create index npr_index_test on AMBULATORY_ACCESS_TEST (APPT_MADE_DATE_YEAR, DEPARTMENT)")
...
FROM (
    ...
    slot_index <- glue("CREATE index slot_index_test on AMBULATORY_SLOT_TEST (APPT_DATE_YEAR, DEPARTMENT_NAME)")
...
access_summary_drop <- glue("DROP TABLE AMBULATORY_ACCESS_SUMMARY_TABLE_TEST")
access_summary_query <- glue("CREATE TABLE AMBULATORY_ACCESS_SUMMARY_TABLE_TEST AS
SELECT
    CAMPUS,
    CAMPUS_SPECIALTY,
    DEPARTMENT,
...
GROUP BY
    ...
    npr_index_summary <- glue("create INDEX npr_index_summary_test on AMBULATORY_ACCESS_NPR_SUMMARY_TABLE_TEST (APPT_MADE_DATE_YEAR, DEPARTMENT)")
...
FROM (VILLEA04.AMBULATORY_ACCESS_TEST) a 
    ...
    index_pop_dev <- glue("create INDEX pop_dev_index_test on AMBULATORY_POPULATION_TEST (APPT_DATE_YEAR, DEPARTMENT)")
