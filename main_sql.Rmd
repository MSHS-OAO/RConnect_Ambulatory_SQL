...
SELECT e.*, CASE WHEN TO_CHAR(APPT_DTTM, 'HH24') >= 12 and TO_CHAR(APPT_DTTM, 'HH24') <= 17 THEN 'PM' 
     WHEN TO_CHAR(APPT_DTTM, 'HH24') < 12 Then 'AM'
     ELSE 'EVE' END AS AM_PM, nvl(e.NEW_PT3_RAW, 'ESTABLISHED') AS NEW_PT3, nvl(e.SCHEDULE_GROUPING, 'Other') AS SCHEDULE_GROUPING_MAPPED,
...
least(greatest(floor(DTTMTOCHECKIN / 5)*5, -65), 60) as bin_checkin,
...
###Query Execution
  tryCatch({
        ...
        dbExecute(conn, "ALTER SESSION DISABLE PARALLEL DML|DDL|QUERY")
