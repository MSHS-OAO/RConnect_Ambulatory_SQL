...
floor(e.DTTMTOCHECKIN / 5)*5 as bin_checkin,
floor(CHECKINTOROOMIN / 30)*30 as bin_roomin, 
floor(CYCLETIME / 30)*30 as bin_cycle,
floor(ROOMINTOVISITEND / 30)*30 as bin_roomin_visit_end
FROM(
