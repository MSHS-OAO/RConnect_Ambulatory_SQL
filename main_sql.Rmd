...
access_index <- glue("CREATE INDEX access_index_testing on AMBULATORY_ACCESS (APPT_DATE_YEAR, DEPARTMENT)")
access_index_npr <- glue("create index npr_index_testing on AMBULATORY_ACCESS (APPT_MADE_DATE_YEAR, DEPARTMENT)")
...
bin_roomin <- glue("begin bin_hist('AMBULATORY_ACCESS', 'CHECKINTOROOMIN', 'bin_roomin', 30, 480, 0); end;")

bin_cycle <- glue("begin bin_hist('AMBULATORY_ACCESS', 'CYCLETIME', 'bin_cycle', 30, 480, 0); end;")

bin_roomin_visit_end <- glue("begin bin_hist('AMBULATORY_ACCESS', 'ROOMINTOVISITEND', 'bin_roomin_visit_end', 30, 480, 0); end;")

bin_dttm_checkin <- glue("begin bin_hist('AMBULATORY_ACCESS', 'DTTMTOCHECKIN', 'bin_dttm_checkin', 5, 60, -60); end;")
