...
access_index <- glue("CREATE index filter_index on AMBULATORY_ACCESS_TABLE (APPT_STATUS, CAMPUS, CAMPUS_SPECIALTY, DEPARTMENT, RESOURCES, PROVIDER, VISIT_METHOD, APPT_TYPE, APPT_DTTM, APPT_DAY)")
