...
utilization_query_scheduled <- glue("SELECT b.CAMPUS, b.CAMPUS_SPECIALTY, b.DEPARTMENT, a.RESOURCES, a.PROVIDER, a.VISIT_METHOD, a.APPT_DATE_YEAR, a.APPT_MONTH_YEAR, a.APPT_YEAR, a.APPT_WEEK, a.APPT_DAY, a.HOLIDAY, a.APPT_DUR, a.APPT_DTTM, a.APPT_STATUS, a.MRN, a.VISIT_END_DTTM, a.ROOMIN_DTTM
    FROM AMBULATORY_ACCESS a 
    INNER JOIN AMBULATORY_MAPPING b ON a.DEPARTMENT_ID = b.DEPARTMENT_ID
