...
#for (j in 1:538) {
  ...
  data.hour.arrived.na <- data.hour.arrived.na %>% group_by(DEPARTMENT_ID, PROV_ID, MRN, APPT_DTTM) %>% 
                          ...
                          mutate(VISIT_END_DTTM = ROOMIN_DTTM + 1.2*APPT_DUR*60)
  ...
  missing_arrived_rows <- anti_join(data.hour.scheduled, data.hour.arrived, by = c("DEPARTMENT_ID"= "DEPARTMENT_ID", "PROV_ID" = "PROV_ID", "MRN" = "MRN", "APPT_DTTM" = "APPT_DTTM"))
