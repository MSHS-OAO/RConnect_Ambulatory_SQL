...
utilization_query_scheduled <- glue("a.DEPARTMENT_ID, a.RESOURCES, a.PROVIDER, a.VISIT_METHOD, a.APPT_DATE_YEAR, a.APPT_MONTH_YEAR, a.APPT_YEAR, a.APPT_WEEK, a.APPT_DAY, a.HOLIDAY, a.APPT_DUR, a.APPT_DTTM, a.APPT_STATUS, a.MRN, a.VISIT_END_DTTM, a.ROOMIN_DTTM
...
# 
# data.hour.arrived$Appt.Start <- data.hour.arrived$Appt.Start
# data.hour.arrived$Appt.End <- data.hour.arrived$Appt.End
# 
# data.hour.arrived <- data.hour.arrived %>% select(-actual.visit.dur)
