...
--SELECT b.*, c.CAMPUS, c.CAMPUS_SPECIALTY, c.HOLIDAY, b.APPT_DATE_YEAR - f.DAYS_SUBTRACT AS APPT_WEEK
--FROM (
    SELECT
    a.DEPARTMENT_NAME, a.PROVIDER_NAME AS PROVIDER,
               ...
               (a.BOOKED_MINUTES + a.CANCELED_MINUTES) AS BOOKED_MINUTES,
                ...
                c.CAMPUS_SPECIALTY, APPT_DATE_YEAR - f.DAYS_SUBTRACT AS APPT_WEEK
        FROM Y_DM_BOOKED_FILLED_RATE a
    RIGHT JOIN AMBUALTORY_UNIQUE_DEPARTMENT c on a.DEPARTMENT_NAME = c.DEPARTMENT AND a.SLOT_BEGIN_TIME BETWEEN TO_DATE('2021-01-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS')
                        AND TO_DATE('2022-08-25 23:59:59', 'YYYY-MM-DD HH24:MI:SS')
    LEFT JOIN SUBTRACT_DAYS f on APPT_DAY = f.WEEKDAY
