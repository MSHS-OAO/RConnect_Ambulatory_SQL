...
FROM V_AVAILABILITY a 
   ...
   GROUP BY c.DEPARTMENT_NAME, c.DEPARTMENT_ID, c.PROV_NM_WID, c.PROV_ID, c.APPT_YEAR, c.APPT_MONTH, c.APPT_DATE_YEAR ,     c.SLOT_BEGIN_TIME, c.SLOT_LENGTH
     ...
     INNER JOIN AMBULATROY_ACCESS e on d.DEPARTMENT_ID = e.DEPARTMENT_ID AND d.PROV_ID = e.PROV_ID AND     d.SLOT_BEGIN_TIME = e.APPT_DTTM")
...
from AMBULATROY_ACCESS a where APPT_STATUS = 'Arrived'")
